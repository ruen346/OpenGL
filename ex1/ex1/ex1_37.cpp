...
void SetupRC()
{
	...
	TexBits = LoadDIBitmap("ex1_37_image\\back.bmp", &info);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, 3000, 3000, 0, GL_BGR_EXT, GL_UNSIGNED_BYTE, TexBits);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	...
	TexBits = LoadDIBitmap("ex1_37_image\\cat.bmp", &info);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, 491, 98, 0, GL_BGR_EXT, GL_UNSIGNED_BYTE, TexBits);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	...
	glPushMatrix();
	{
		...
		*/
		...
		glPushMatrix();//벽
		{
			...
			glBegin(GL_QUADS);
			glTexCoord2d(0.0f, 1.0f);
			glVertex3f(-1500.0, 1500.0, -1500);
			glTexCoord2d(0.0f, 0.0f);
			glVertex3f(1500.0, 1500.0, -1500);
			glTexCoord2d(1.0f, 0.0f);
			glVertex3f(1500.0, -1500.0, -1500.0);
			glTexCoord2d(1.0f, 1.0f);
			glVertex3f(-1500.0, -1500.0, -1500.0);
			glEnd();
		...
		glPushMatrix();//냥냥냥
		{
			glBindTexture(GL_TEXTURE_2D, cat);
			glBegin(GL_QUADS);
			glTexCoord2d(x[0], 1.0f);
			glVertex3f(-100.0, 100.0, 100.0);
			glTexCoord2d(x[0], 0.0f);
			glVertex3f(-100.0, -100.0, 100.0);
			glTexCoord2d(x[1], 0.0f);
			glVertex3f(100.0, -100.0, 100.0);
			glTexCoord2d(x[1], 1.0f);
			glVertex3f(100.0, 100.0, 100.0);
			glEnd();
			...
			glTexCoord2d(x[1], 0.0f);
			glVertex3f(100.0, -100.0, 100.0);
			glTexCoord2d(x[2], 0.0f);
			glVertex3f(100.0, -100.0, -100.0);
			glTexCoord2d(x[2], 1.0f);
			glVertex3f(100.0, 100.0, -100.0);
			glEnd();
			...
			glTexCoord2d(x[2], 0.0f);
			glVertex3f(100.0, 100.0, -100.0);
			glTexCoord2d(x[3], 0.0f);
			glVertex3f(100.0, -100.0, -100.0);
			glTexCoord2d(x[3], 1.0f);
			glVertex3f(-100.0, -100.0, -100.0);
			glEnd();
